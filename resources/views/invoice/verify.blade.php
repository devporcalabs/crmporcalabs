...
<head>
    ...
    <title>Verifikasi Dokumen — Invoice {{ $invoice->nomor ?? 'DRAFT' }}</title>
    ...
    <div class="verify-card">
        ...
        <div class="details-box">
            <div class="detail-row">
                ...
                <span class="detail-value">Invoice / Tagihan Resmi</span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Nomor Dokumen</span>
                <span class="detail-value">{{ $invoice->nomor ?? 'DRAFT' }}</span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ $invoice->client->perusahaan ?? $invoice->client->nama }}</span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Total Tagihan</span>
                <span class="detail-value">Rp {{ number_format($invoice->grand_total, 0, ',', '.') }}</span>
            </div>
            <div class="detail-row">
